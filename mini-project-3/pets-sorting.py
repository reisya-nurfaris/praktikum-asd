...
class Shop:
    items ={
        ...
        "3": {"nama": "Penua instan", "harga": 200, "deskripsi": "Ya biar makin tua", "efek": {"umur": 10}},
        "4": {"nama": "Yamaha Mio Gear 125 S", "harga": 5000, "deskripsi": "y.", "efek": {}}
    }
                    ...
                    if Shop.items.get(chosen_item['id'])['efek']:
                        ...
                        if amount_to_use > chosen_item['jumlah']:
                            ...
                            if chosen_item['jumlah'] == 0:
                                self.barang.pop(item_index - 1)  # Remove item from inventory if quantity becomes 0
